  ...
  const monsterStatblockContent = [
              ...
              content: [
                {
                  type: 'paragraph',
                  content: [
                    { type: 'text', text: generatedMonster.stats.dexterity },
                  ],
                },
              ],
            },
              ...
              content: [
                {
                  type: 'paragraph',
                  content: [
                    { type: 'text', text: generatedMonster.stats.constitution },
                  ],
                },
              ],
            },
              ...
              content: [
                {
                  type: 'paragraph',
                  content: [
                    { type: 'text', text: generatedMonster.stats.intelligence },
                  ],
                },
              ],
            },
    ...
    { type: 'horizontalRule' },
    {
      ...
      content: [
        ...
        { type: 'text', text: generatedMonster.attributes.savingThows },
        { type: 'hardBreak' },
        {
          type: 'text',
          marks: [{ type: 'bold' }],
        ...
        { type: 'text', text: generatedMonster.attributes.damageResistances },
        { type: 'hardBreak' },
        {
          type: 'text',
          marks: [{ type: 'bold' }],
        ...
        { type: 'text', text: generatedMonster.attributes.damageImmunities },
        { type: 'hardBreak' },
        {
          type: 'text',
          marks: [{ type: 'bold' }],
        ...
        { type: 'text', text: generatedMonster.attributes.conditionImmunities },
        { type: 'hardBreak' },
        {
          type: 'text',
          marks: [{ type: 'bold' }],
