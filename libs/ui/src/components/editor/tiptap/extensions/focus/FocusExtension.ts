// A temporary vendor of the FocusExtension from Tiptap
// with a small modification to remove the isFocused check
// due to this bug: https://github.com/ueberdosis/tiptap/issues/5980
