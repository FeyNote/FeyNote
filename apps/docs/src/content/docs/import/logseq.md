...
4. [Step 4: Open in Directory](#step-4-open-in-directory)
5. [Step 5: Locate the Logseq Folder](#step-5-locate-the-logseq-folder)
6. [Step 6: Copy the Assets Folder](#step-6-copy-the-assets-folder)
7. [Step 7: Zip the Files Together](#step-7-zip-the-files-together)
...
![Cursor hovering over the Logseq path in their system file explorer](https://static.feynote.com/screenshots/import-instructions/logseq/logseq-file-explorer-button-20250527.png)
...
![Cursor copying the assets folder in their Logseq directory](https://static.feynote.com/screenshots/import-instructions/logseq/assets-folder-20250527.png)
...
![Cursor copying the assets folder in their Logseq directory](https://static.feynote.com/screenshots/import-instructions/logseq/asserts-and-graph-to-zip-20250527.png)

That's it! Your graph is now zipped up and ready to upload!

---

## macOS

This section will be filled out in the future, in the meantime please follow the Windows instructions as the processes across OS will be largely the same.
