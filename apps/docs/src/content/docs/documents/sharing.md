...
- The **Shared With You** card on the dashboard shows your most recently updated shared documents. Clicking the section header opens the All Documents page with the "Shared with me" filter pre-applied.
